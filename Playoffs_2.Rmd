...
Team_Adv_Stats <- Team_Adv_Stats %>% select(-c(31:33)) %>% rename('Outscoring' = 'Outscoring.x',
                                                                  'Outscored' = 'Outscored.x',
                                                                  'HCA' = 'HCA.x')
```
...
NBA_Master <- merge(NBA_Master, Home_Games_Summary, by.x = 'nameTeam', by.y = 'nameTeam_home')
NBA_Master <- merge(NBA_Master, Away_Games_Summary, by.x = 'nameTeam', by.y = 'nameTeam_away')
